...
5. Prove consent. The capability is issued while identities, decisions, and threshold remain hidden.
6. Process once. The AI adapter returns a short summary and contract state becomes consumed.
